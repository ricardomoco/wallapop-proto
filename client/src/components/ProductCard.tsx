  ...
  return (
    <div className="overflow-hidden" style={{ maxWidth: "100%" }}>
      <div className="relative">
        ...
        {product.isReserved && (
          <div className="absolute top-2 left-2 bg-purple-600 text-white text-xs font-medium px-2 py-1 rounded-md flex items-center shadow-sm">
        ...
        <button
          ...
          disabled={isPending}
          className="absolute right-2 top-2 h-8 w-8 rounded-full bg-white flex items-center justify-center shadow-sm transition-transform active:scale-90"
