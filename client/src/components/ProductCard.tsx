  ...
  return (
    <div className="bg-white rounded-lg overflow-hidden shadow mb-4">
      <div className="relative">
        ...
        {product.isReserved && (
          <div className="absolute top-2 right-2 bg-purple-500 text-white text-xs font-medium px-2 py-1 rounded flex items-center">
        ...
        <button
          ...
          disabled={isPending}
          className="absolute right-2 bottom-2 h-8 w-8 rounded-full bg-white flex items-center justify-center shadow transition-colors"
        >
          {isFavorite ? (
      ...
      <div className="p-3">
        <div className="text-xl font-bold mb-1">{product.formattedPrice}</div>
